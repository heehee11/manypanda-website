  ...
  <div class="myPage">
            ...
            <div class="owl-carousel prod-owl-list owl-theme owl-loaded">
              <div class="owl-stage-outer">
                <div class="owl-stage"
                  ...
                  <div v-if="profile" class="owl-item active" style="width: 200px; margin-right: 0px;">
                    <div class="item _item"><img style="width: 200px; height: 200px; margin-left: 600px; border-radius: 100px;"
                        :src="profile.fileDb[0].fileUrl" alt=""></div>
                  </div>
                  <div v-else class="owl-item active" style="width: 200px; margin-right: 0px;">
                    <div class="item _item"><img style="width: 200px; height: 200px; margin-left: 600px;"
                        src="../../assets/image/profile.jpg" alt=""></div>
                  </div>
    ...
    <div class="d-flex align-items-start">
      <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <!-- <button
          style="color:black; font-size:14px; width: 100px; height: 40px; margin-left: 300px; margin-bottom: 60px;"
          class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-buy" type="button"
          role="tab" aria-controls="v-pills-profile" aria-selected="false">구매내역</button><br> -->
        <!-- <button
          style="color:black; font-size:14px; width: 100px; height: 40px; margin-left: 300px; margin-bottom: 60px;"
          class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-tag" type="button"
          role="tab" aria-controls="v-pills-settings" aria-selected="false">알림태그</button><br> -->
        <!-- <button style="color:black; font-size:14px; width: 100px; height: 40px; margin-left: 300px; margin-bottom: 60px;"  
        class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-chat" type="button" 
        role="tab" aria-controls="v-pills-settings" aria-selected="false">채팅목록</button> -->
      ...
      <div class="tab-content" id="v-pills-tabContent">
        ...
        <!-- <div class="tab-pane fade" id="v-pills-buy" role="tabpanel" aria-labelledby="v-pills-profile-tab">
          <MyPageSale></MyPageSale>
        </div> -->
    ...
    getProfile() {
      ProfileService.getFiles()
        .then((response) => {
          ...
          console.log("이미지");
          console.log(response.data);
          alert(response.data.fileDb.fiilUrl);
        })
        .catch((e) => {
          console.log(e);
        })
