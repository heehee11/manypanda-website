    ...
    <div class="myPage">
        <div style="margin:auto; text-align:center;">
            <div style="display:inline;">
                <input type="file" accept="image/*" ref="file" @change="selectImage" style="font-size:12px; margin-bottom:50px;" />
                ...
                <!-- 업로드/취소 버튼 시작 -->
                        ...
                        <div class="button">
                            <button @click="cancel" class="cancleButton" style=" font-size: 12px;"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square"
                                    viewBox="0 0 16 16">
                                    <path
