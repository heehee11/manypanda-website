          ...
          <div v-if="!successful">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input v-model="user.nick" type="text" class="form-control" id="nickname" placeholder="" value=""
                  required>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input v-model="user.password" v-validate="'required|min:6|max:40'" name="password" type="password" style="font-size:12px; height: 40px;;"
                  class="form-control" id="password" placeholder="대문자,숫자,특수문자 조합"  value="" required
                  @blur="passwordValid" :style="myStyle">
                <div class="invalid-feedback" style="font-size:12px;">
            ...
            <div class="mb-3">
              ...
              <input v-model="user.email" v-validate="'required|email|max:50'" name="email" type="email"
                class="form-control" id="emailId" placeholder="manypanda@manypanda.com" style="font-size:12px;" required>
              <div class="invalid-feedback" style="font-size:12px;">
                이메일을 입력해주세요.
              </div>
            </div>
            ...
            <!-- <footer class="my-3 text-center text-small">
                <p class="mb-1">&copy; 2022 DAPANDA</p> -->
            <!-- <div v-if="message" class="alert" :class="successful ? 'alert-success' : 'alert-danger'">{{ message }}
              </div> -->
            <!-- </footer> -->

            <!-- TODO: 회원가입완료시 회원가입완료 알림 추가해야합니다. -->
...
export default {
  ...
  computed: {
    ...
    //   return () =>
    //     this.password !== this.passwordCheck || "패스워드가 일치하지 않습니다";
    // }
  },
  mounted() {
  ...
  methods: {
    ...
    // TODO: 유효성체크 대문자, 숫자, 특문 하나씩들어가야함 경고메세지 출력만들어야합니다.
    // 비밀번호 유효성 체크
