                        ...
                        <!-- <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <article><a href="/"><img src="../../assets/image/homelogo.png"
                                                class="d-block w-100"></a></article>
                                    <article><img src="../../assets/image/homelogo.png" class="d-block w-100"></article>
                                    <article><img src="../../assets/image/homelogo.png" class="d-block w-100"></article>
                                </div>
                            ...
                            <button class="carousel-control-prev" type="button"
                                data-bs-target="#carouselExampleInterval" data-bs-slide="prev" style="color:black">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="visually-hidden" style="color:black">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button"
                                data-bs-target="#carouselExampleInterval" data-bs-slide="next" style="color:black">
