                ...
                style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
                    <a :href="`/fb/${data.fno}`" style="text-decoration: none;" >
                      <font color="black" size="2px" >{{ data.fbTitle }}</font></a>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <div class="writeTable" style="margin-bottom:20px; margin-top:20px; margin-left: 150px;  text-align: left">
              ...
              <tr style="font-size: 14px;  ">
                ...
                <select required class="search"
                        ...
                        <option 
                        :key="index" 
                        :value="fbCategory.fbCid" 
                        v-for="(fbCategory, index) in fbCategories">
                          {{ fbCategory.fbCtitle }}
                        </option>
                </select>
              </td>
              ...
              <tr data-v-224097a6="" style="font-size: 14px;">
                ...
                <td>
                  ...
                  v-model="fbTitle" 
                  v-validate="'required'"
                  id="fbTitle" name="fbTitle"
                  placeholder="제목을 입력하세요" 
                  class="category" 
                  :class="{ 'is-invalid': submitted && errors.has('fbTitle') }"
                  style=" font-size: 12px; width: 80%; margin: 10px; ">
                  <div v-if="submitted && errors.has('fbTitle')" 
                              class="invalid-feedback">{{ errors.first('fbTitle') }}</div>
                </td>
              </tr>
