        ...
        <div class="container " data-aos="fade-left" data-aos-delay="200">
          <div class="row">
            ...
            <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              ...
              >
                <tr v-for="(data, index) in fbBoardBest" :key="index" data-v-224097a6="" style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
            ...
            <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              ...
              <tbody border="0" class="table-group-divider" data-v-224097a6="" style="text-align: center;"  
              >
                <tr v-for="(data, index) in fbBoardRcntBest" :key="index" data-v-224097a6="" style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
                    <a :href="`/fb/${data.fno}`" style="text-decoration: none;" ><font color="black" size="2px" >{{ data.fbTitle }}</font></a>
                  </td>
                </tr>
            ...
            <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              <thead data-v-224097a6="">
                <tr data-v-224097a6="" style="font-size: 22px;">
                  <th scope="col" data-v-224097a6="">
                    <a href="/community-free-board" size="2px"><img src="../../../assets/image/board/showban.png" alt="">
                    </a>
                  </th>
            ...
            <div class="searchButton">
              ...
              <input class="search" 
                     v-model="fb_title" @keyup.enter="retrieveFb();"
            ...
            <table class="table" data-v-224097a6="">
              ...
              <tbody class="table-group-divider" 
                     v-for="(data, index) in fb" :key="index"
                      data-v-224097a6="" style="text-align: center;">
                <tr data-v-224097a6="" style="font-size: 14px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">{{ data.fbCtitle }}</td>
                  <td data-v-224097a6="" ><a :href="`/fb/${data.fno}`" style="text-decoration: none;" ><font color="black" >{{ data.fbTitle }}</font></a></td>
                  <td data-v-224097a6="">{{ data.nick }}</td>
                  <td data-v-224097a6="">{{ data.fbCnt }}</td>
    ...
    retrieveFbBoardRcntBest() {
      ...
      FbService.getAll(
        ...
        this.pageSize)
         // 성공하면 .then() 결과가 전송됨
        .then((response) => {
          const { fb, totalItems } = response.data; // springboot 의 전송된 맵 정보
          this.fb = fb;        // 스프링부트에서 전송한 데이터
