        ...
        <div class="container " data-aos="fade-left" data-aos-delay="200">
          <div class="row">
            ...
            <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              ...
              >
                <tr v-for="(data, index) in lbBoardBest" :key="index" data-v-224097a6="" style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
            ...
            <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              <thead data-v-224097a6="">
                <tr data-v-224097a6="" style="font-size: 22px;">
                  <th scope="col" data-v-224097a6="">
                    <a href="/community-lost-board" size="2px"><img src="../../../assets/image/board/showban.png" alt="">
                    </a>
                  </th>
            ...
            <div class="searchButton">
              ...
              <input class="search" 
                     v-model="lb_title" @keyup.enter="retrieveLb();"
            ...
            <table class="table" data-v-224097a6="">
              ...
              <tbody class="table-group-divider" 
                     v-for="(data, index) in lb" :key="index"
                      data-v-224097a6="" style="text-align: center;">
                      <tr data-v-224097a6="" style="font-size: 14px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">{{ data.lbCtitle }}</td>
                  <td data-v-224097a6="" ><a :href="`/lb/${data.lno}`" style="text-decoration: none;" >
                    <font color="black" >{{ data.lbTitle }}</font></a></td>
                  <td data-v-224097a6="">{{ data.nick }}</td>
                  <td data-v-224097a6="">{{ data.lbCnt }}</td>
  ...
  methods: {
    write() {
      if(this.$store.state.auth.user) {
        location.href='/lost-Board-Write';
      } else {
