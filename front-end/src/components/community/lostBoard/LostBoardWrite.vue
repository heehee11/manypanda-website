        ...
        <div class="container " data-aos="fade-left" data-aos-delay="200">
          <div class="row">
           ...
           <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              ...
              <tbody border="0" class="table-group-divider" data-v-224097a6="" style="text-align: center;"  
              >
                <tr v-for="(data, index) in lbBoardRcntBest" :key="index" data-v-224097a6="" style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
                    <a :href="`/lb/${data.lno}`" style="text-decoration: none;" ><font color="black" size="2px" >{{ data.lbTitle }}</font></a>
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <table class="tableWrite">
                ...
                <thead>
                  <tr style="font-size: 14px;  ">
                    ...
                    <td>
                      <select required class="search" 
                      v-model="selectLbCategory" 
                      name="count" data-title="선택"
                        ...
                        <option :key="index" :value="lbCategory.lbCid" 
                        v-for="(lbCategory, index) in lbCategories">
                          {{ lbCategory.lbCtitle }}
                        </option>
                      </select>
                    </td>
                  ...
                  v-model="lbTitle" 
                  v-validate="'required'"
                  id="lbTitle" name="lbTitle"
                  placeholder="제목을 입력하세요" 
                  class="category" 
                  :class="{ 'is-invalid': submitted && errors.has('lbTitle') }"
                  style=" font-size: 12px; width: 80%; margin: 10px; ">
                  <div v-if="submitted && errors.has('lbTitle')" 
                              class="invalid-feedback">{{ errors.first('lbTitle') }}</div>
                    </td>
                  </tr>
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td style="width: 80%;">
                      <input type="text" placeholder="내용을 입력하세요" class="category" v-model="lbContent"
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td>
                      <input type="text" placeholder="#태그를 입력하세요" class="category" v-model="lbTag"
                        style=" font-size: 12px; width: 80%; margin: 10px; ">
                    </td>
                  </tr>
