                ...
                style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
                    <a :href="`/bb/${data.bno}`" style="text-decoration: none;" >
                      <font color="black" size="2px" >{{ data.bbTitle }}</font></a>
                  </td>
                </tr>
              </tbody>
            </table>
           ...
           <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
            ...
            <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              <thead data-v-224097a6="">
                <tr data-v-224097a6="" style="font-size: 22px;">
                  <th scope="col" data-v-224097a6="">
                    <a href="/community-best-board" size="2px"><img src="../../../assets/image/board/showban.png" alt="">
                    </a>
                  </th>
            ...
            <div class="writeTable" style="margin-bottom:20px; margin-top:20px; margin-left: 150px;  text-align: left">
              ...
              <tr style="font-size: 14px;  ">
                ...
                <select required class="search"
                        ...
                        <option 
                        :key="index" 
                        :value="bbCategory.bbCid" 
                        v-for="(bbCategory, index) in bbCategories">
                          {{ bbCategory.bbCtitle }}
                        </option>
                </select>
              </td>
              ...
              <tr data-v-224097a6="" style="font-size: 14px;">
                ...
                <td>
                  ...
                  v-model="bbTitle" 
                  v-validate="'required'"
                  id="bbTitle" name="bbTitle"
                  placeholder="제목을 입력하세요" 
                  class="category" 
                  :class="{ 'is-invalid': submitted && errors.has('bbTitle') }"
                  style=" font-size: 12px; width: 80%; margin: 10px; ">
                  <div v-if="submitted && errors.has('bbTitle')" 
                              class="invalid-feedback">{{ errors.first('bbTitle') }}</div>
                </td>
              </tr>
            ...
            <div class="button">
              ...
              @click.prevent="upload"><svg xmlns="http://www.w3.org/2000/svg" width="16"
  ...
  methods: {
    ...
    upload(e) {
            ...
            this.$validator.validate().then(valid => {
                if (valid) {
                    // alert('SUCCESS!! :-)\n\n' + JSON.stringify(this.bb))
                    this.progress = 0;

      // 서버에 이미지 업로드 요청(insert 문 실행)
      BbService.create(
        this.nick,
        this.selectBbCategory,
        this.bbTitle,
        this.bbContent,
        this.bbTag,
        this.currentImage,
