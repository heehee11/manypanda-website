        ...
        <div class="container " data-aos="fade-left" data-aos-delay="200">
          <div class="row">
           ...
           <table class="table" data-v-224097a6="" style="width: 30%; margin-left: 30px;">
              ...
              <tbody border="0" class="table-group-divider" data-v-224097a6="" style="text-align: center;"  
              >
                <tr v-for="(data, index) in bbBoardRcntBest" :key="index" data-v-224097a6="" style="font-size: 18px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">
                    <a :href="`/bb/${data.bno}`" style="text-decoration: none;" ><font color="black" size="2px" >{{ data.bbTitle }}</font></a>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <div class="searchButton">
              <select class="search" v-model="bb_ctitle" name="count" data-title="선택"
              ...
              <input class="search" v-model="bb_title" @keyup.enter="retrieveBb();" type="text" name="search"
                id="searchId" placeholder="검색하세요..." style="width: 25%; font-size: 12px;">

              <button class="button" style=" font-size: 12px;" @click="write"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <table class="table" data-v-224097a6="">
              ...
              <tbody class="table-group-divider" v-for="(data, index) in bb" :key="index" data-v-224097a6=""
                style="text-align: center;">
                <tr data-v-224097a6="" style="font-size: 14px; background-color: rgb(255, 255, 255);">
                  <td data-v-224097a6="">{{ data.bbCtitle }}</td>
                  <td data-v-224097a6=""><a :href="`/bb/${data.bno}`" style="text-decoration: none;">
                      <font color="black">{{ data.bbTitle }}</font>
                    </a></td>
                  <td data-v-224097a6="">{{ data.nick }}</td>
                  <td data-v-224097a6="">{{ data.bbCnt }}</td>
  ...
  methods: {
    ...
    write() {
      if (this.$store.state.auth.user) {
        location.href = '/best-Board-Write';
      } else {
